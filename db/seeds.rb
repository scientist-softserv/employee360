...
unless User.exists?(email: admin_email)
  ...
  # Load job titles from YAML file
  job_titles = salary_config['job_titles']
  # Exclude "VP of Software Services" since set manually below
  job_titles.delete("VP of Software Services")
  ...
  users_data << {
    ...
    next_1_on_1: Date.new(2022, 6, 30) - 28,
    role: :admin,
    goals_attributes: [
  ...
  users_data << {
    email: 'rob@scientist.com',
    github_handle: 'orangewolf',
    password: 'testing123',
    name: 'Rob Kaufman',
    start_date: Date.new(2022, 12, 1),
    title: 'VP of Software Services',
    last_promotion: nil,
    current_compensation: "No Idea $",
    ...
    salary_histories_attributes: [
      {
        job_title: 'VP of Software Services',
        salary: "No Idea $",
        change_date: Date.new(2022, 12, 1),
        change_reason: 'New Hire'
      },
      {
        job_title: job_titles.sample,
